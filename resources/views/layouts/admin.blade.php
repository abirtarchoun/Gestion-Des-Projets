...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jun 2020 22:14:22 GMT -->

<!-- Mirrored from zfda.go.tz/products/1/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 May 2021 07:34:59 GMT -->
<head>
	<meta charset="utf-8" />
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown language-switch">
							...
							<ul class="dropdown-menu">
								<li>
									<a class="deutsch"><img src="{{ asset('img/flags/de.pn') }}g" alt=""> Deutsch</a>
								</li>
								<li>
									<a class="ukrainian"><img src="{{ asset('img/flags/ua.png') }}" alt=""> Українська</a>
								</li>
								<li>
									<a class="english"><img src="{{ asset('img/flags/gb.png') }}" alt=""> English</a>
								</li>
								<li>
									<a class="espana"><img src="{{ asset('img/flags/es.png') }}" alt=""> España</a>
								</li>
								<li>
									<a class="russian"><img src="{{ asset('img/flags/ru.png') }}" alt=""> Русский</a>
								</li>
							</ul>
						</li>
						<!-- end language menu -->
								...
								<li>
									<ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
										<li>
											<a href="#">
												<span class="photo">
													<img src="{{asset('img/prof/prof2.jpg')}}" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="{{asset('img/prof/prof3.jpg')}}" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="{{asset('img/prof/prof1.jpg')}}" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="{{asset('img/prof/prof8.jpg')}}" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="{{asset('img/prof/prof5.jpg')}}" class="img-circle" alt="">
												</span>
												<span class="subject">
...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jun 2020 22:14:23 GMT -->

<!-- Mirrored from zfda.go.tz/products/1/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 May 2021 07:35:05 GMT -->
</html>
