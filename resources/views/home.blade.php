					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								<div class="user-panel">
									<div class="pull-left image">
										<img src="{{asset('img/dp.jpg')}}" class="img-circle user-img-circle"
											alt="User Image" />
									</div>
								...
								<ul class="sub-menu">
									<li class="nav-item active">
										<a href="index-2.html" class="nav-link ">
											<span class="title">Dashboard content</span>
											<span class="selected"></span>
										</a>
									</li>
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="all_assets.html" class="nav-link "> <span class="title">All Course Materials</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="add_library.html" class="nav-link "> <span class="title">Add Course Materials</span>
										</a>
									</li>
							...
							<li class="nav-item">
								<a href="#" class="nav-link nav-toggle"> <i class="material-icons">business</i>
									<span class="title">teams</span> <span class="arrow"></span>
								</a>
								<ul class="sub-menu">
									<li class="nav-item">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-12 col-sm-6">
							<div class="blogThumb">
								<div class="thumb-center"><img class="img-responsive" alt="user"
										src="{{asset('')}}/img/course/course1.jpg"></div>
						...
						<div class="col-lg-3 col-md-6 col-12 col-sm-6 ">
							<div class="blogThumb">
								<div class="thumb-center"><img class="img-responsive" alt="user"
										src="{{asset('img/course/course2.jpg')}}"></div>
								<div class="course-box">
									<h4>PHP Development Course</h4>
									<div class="text-muted"><span class="m-r-10">April 23</span>
										<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
						...
						<div class="col-lg-3 col-md-6 col-12 col-sm-6">
							<div class="blogThumb">
								<div class="thumb-center"><img class="img-responsive" alt="user"
										src="{{asset('img/course/course3.jpg')}}"></div>
								<div class="course-box">
									<h4>PHP Development Course</h4>
									<div class="text-muted"><span class="m-r-10">April 23</span>
										<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
						...
						<div class="col-lg-3 col-md-6 col-12 col-sm-6">
							<div class="blogThumb">
								<div class="thumb-center"><img class="img-responsive" alt="user"
										src="{{asset('img/course/course4.jpg')}}"></div>
								<div class="course-box">
									<h4>PHP Development Course</h4>
									<div class="text-muted"><span class="m-r-10">April 23</span>
										<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
									...
									<ul class="feedBody">
										<li class="active-feed">
											<div class="feed-user-img">
												<img src="{{asset('img/std/std1.jpg')}}" class="img-radius "
										...
										<li class="diactive-feed">
											<div class="feed-user-img">
												<img src="{{asset('img/std/std2.jpg')}}" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
										...
										<li class="diactive-feed">
											<div class="feed-user-img">
												<img src="{{asset('img/std/std3.jpg')}}" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
										...
										<li class="active-feed">
											<div class="feed-user-img">
												<img src="{{asset('img/std/std4.jpg')}}" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
										...
										<li class="active-feed">
											<div class="feed-user-img">
												<img src="{{asset('img/std/std5.jpg')}}" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
												<span class="feedLblStyle lblFileStyle">File</span> Sarah Smith <small
										...
										<li class="diactive-feed">
											<div class="feed-user-img">
												<img src="{{asset('img/std/std6.jpg')}}" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
												<span class="feedLblStyle lblTaskStyle">Task </span> Jalpa Joshi<small
							...
							<div class="chat-sidebar-list">
								<div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd"
									...
									<ul class="media-list list-items">
										<li class="media"><img class="media-object" src="{{asset(img/prof/prof3.jpg)}}"
										...
										<li class="media">
											...
											</div> <img class="media-object" src="{{asset('img/prof/prof1.jpg')}}"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{asset('img/prof/prof5.jpg')}}"
												width="35" height="35" alt="...">
											<i class="away dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="{{asset('img/prof/prof4.jpg')}}"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{asset('img/prof/prof2.jpg')}}"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{asset('img/prof/prof7.jpg')}}"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											</div> <img class="media-object" src="{{asset('img/prof/prof6.jpg')}}"
												width="35" height="35" alt="...">
										...
										<li class="media"><img class="media-object" src="{{asset('img/prof/prof8.jpg')}}"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="{{asset('img/prof/prof9.jpg')}}"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{asset('img/prof/prof10.jpg')}}"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
