		                                                       ...
		                                                       @foreach ($etudiants as $key => $etudiant)
                                                                <tr class="odd gradeX">
                                                                       <td>{{ $key }}</td>
																		...
																		<td><a href="mailto:shuxer@gmail.com">{{$etudiant->email }}</a></td>
																		<td>{{ $etudiant->admission_date }}</td>
																		<td>
																		...
																		<a href="{{ route('etudiants.show', ['etudiant' => $etudiant->id]) }}" class="btn btn-info btn-xs" title="Show details about {{ $etudiant->nom.' '.$etudiant->prenom  }}">
                                                                        <i class="fa fa-user-circle-o"></i> 
																		</a>
																		<a href="#" class=" Success btn btn-danger btn-xs" title="Delete user {{ $etudiant->nom.' '.$etudiant->prenom  }}" onclick="event.preventDefault(); document.querySelector('#delete-etudiant-form').submit()">
