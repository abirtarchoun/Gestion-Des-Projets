									...
									<div class="form-group row">
										<label for="nom" class="control-label col-md-3">First Name</label>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <input class="form-control input-height" type="file" name="picture" id="picture" class="form-control" value="{{$enseignant->picture  ?? old('picture ') }}" placeholder="Enseignant's photo goes here">
