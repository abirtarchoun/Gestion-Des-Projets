                ...
                <label for="nom" class="control-label col-md-3">First Name
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                           ...
                           <input type="email" class="form-control input-height"  name="email" value="{{ $enseignant->etudiant ?? old('email') }}" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="person@example.com">
