 ...
 @section('content')
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <li class="drop-down"><a href="#"><i class="material-icons"> Projects </i></a>
	      <ul class="sub-menu">
		<li><a href="all_professors.html" class="nav-link "> <span class="title">All Projects</span>
		</a></li>
        </ul>
        <li class="drop-down"><a href="#"><i class="material-icons"> Students</i></a>
	    <ul class="sub-menu">
		<li><a href="all_professors.html" class="nav-link "> <span class="title">All Students</span></a></li>
        </ul>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h2>one team. one misson. one goal. Knowledge</h2>
  ...
  <script src="{{ asset('jquery.easing/jquery.easing.min.js')}}" defer></script>
